...
public class Log {
	...
	public static void message(String description, WebDriver driver, Boolean... takeScreenShot) {
		...
		if (configProperty.getProperty(ConfigurationProperties.SCREENSHOT_FLAG) != null && configProperty.getProperty(ConfigurationProperties.SCREENSHOT_FLAG).equalsIgnoreCase("false")) {
			finalDecision = false;
		}
