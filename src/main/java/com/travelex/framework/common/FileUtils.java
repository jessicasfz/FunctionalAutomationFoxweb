...
public class FileUtils {
	...
	/**Method writes content to file 
	 * @param FileName - Source file
	 * @param columnName - column which need to update
	 * @param rowName - row name which need to update
	 * @param text - text need to be updated
	 * @return boolean - result of file write
	 * @throws Exception 
	 */
	public static boolean writeFile(String FileName, String columnName, String rowName, String text) throws Exception{  
		boolean result = true;
		  try{
			 
		    FileInputStream textFile=new FileInputStream(System.getProperty("user.dir")+FileName);  
		    //Write the logic for writing the text
		    textFile.close(); 
